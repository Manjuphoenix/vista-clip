...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def forward_features(self, features):
        ...
        # print("---ionoign---", features.keys(), "******")     # Returns dict with keys res2, res3, res4, res5
        #print("---ionoign---", self.transformer_in_features, "******")     # Returns dict with keys res3, res4, res5
        # print(OIHIONI)
        srcs = []
        pos = []
